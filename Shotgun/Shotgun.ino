...
//int gunCenterX = 577;   //WIDESCREEN
//int gunCenterY = 350;   //WIDESCREEN
int gunCenterX = 580;   //PC
int gunCenterY = 375;   //PC
...
void handleButtons() {
  ...
  if ((triggerA_now != button_triggerA) && (triggerB_now == 0)) {
    button_triggerA = triggerA_now;
    if (button_triggerA == 1) {
